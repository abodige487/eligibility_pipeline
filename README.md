...
The pipeline ingests eligibility files from multiple healthcare partners,
standardizes their schemas, and produces a single unified output dataset.

The design ensures that onboarding a new partner requires only configuration
changes and no changes to core processing logic.
